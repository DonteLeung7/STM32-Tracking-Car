...
unsigned char Wave[]={0X00,0X01,0X02,0X04,0X08,0X10,0X20,0X40,0X80,0XFF};
...
{ 	
	  ...
	  GPIO_InitStructure.GPIO_Pin  = GPIO_Pin_12|GPIO_Pin_15;//PE2~4
	  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 
	  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
 	  GPIO_Init(GPIOA, &GPIO_InitStructure);//初始化GPIOE2,3,4
	
	  GPIO_SetBits(GPIOA,GPIO_Pin_12|GPIO_Pin_15);	//PD3,PD6 输出高
