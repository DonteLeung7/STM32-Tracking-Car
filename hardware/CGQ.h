...
#define CG_Z3  GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_0)
#define CG_Y1  GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_0)
#define CG_Y2  GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_1)
#define CG_Y3  GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_1)
