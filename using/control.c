...
void  SetMotorVoltageAndDirection(int i16LeftVoltage, int i16RightVoltage)
{
	...
	if(i16LeftVoltage < 0)
	{
		GPIO_SetBits(GPIOB, GPIO_Pin_12 );		//AIN1,AIN2		    
	...
	{
		GPIO_SetBits(GPIOB, GPIO_Pin_14 );		//BIN0,BIN1		    
	...
	{
		TIM_SetCompare1(TIM3,i16LeftVoltage);
		TIM_SetCompare2(TIM3,i16RightVoltage);
	}
}
